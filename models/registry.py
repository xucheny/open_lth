...
from models import cifar_resnet, cifar_vgg, mnist_lenet, imagenet_resnet, vqe_tfim1d, vqe_xxz1d, eigensolver
...
registered_models = [mnist_lenet.Model, cifar_resnet.Model, cifar_vgg.Model, imagenet_resnet.Model,
        vqe_tfim1d.Model, vqe_xxz1d.Model, eigensolver.Model]
