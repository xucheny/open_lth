...
from utils.qc_model_utils import Energy, PlaceholderLoss, HamiltonianVariationalAnsatz, get_TFIM_setup
...
class Model(base.Model):
    ...
    def __init__(self, num_qubits, num_layers, g, initializer):
        ...
        parameterized_ops, observable, input_state = get_TFIM_setup(num_qubits, g)
    ...
    def is_valid_model_name(model_name):
        ...
        return (
                ...
                all([isfloat(x) and float(x) > 0 and float(x) <= 1 for x in model_name.split('_')[4:]])
                )
    ...
    def default_hparams():
        model_hparams = hparams.ModelHparams(
            model_name='vqe_tfim1d_3_10_0.1',
